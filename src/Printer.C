...
void PrintAbsyn::visitClassDefNoInher(ClassDefNoInher* p)
{
  int oldi = _i_;
  if (oldi > 0) render(_L_PAREN);
  ...
  visitIdent(p->ident_);
  render('{');
  if(p->listclassinstr_) {_i_ = 0; p->listclassinstr_->accept(this);}  render('}');
...
void PrintAbsyn::visitClassDefInher(ClassDefInher* p)
{
  int oldi = _i_;
  if (oldi > 0) render(_L_PAREN);
...
void PrintAbsyn::visitClassInstr(ClassInstr*p) {} //abstract class

void PrintAbsyn::visitMethodDef(MethodDef* p)
{
  int oldi = _i_;
  if (oldi > 0) render(_L_PAREN);
...
void PrintAbsyn::visitFieldDef(FieldDef* p)
{
  int oldi = _i_;
  if (oldi > 0) render(_L_PAREN);
...
void PrintAbsyn::visitListClassInstr(ListClassInstr *listclassinstr)
{
  for (ListClassInstr::const_iterator i = listclassinstr->begin() ; i != listclassinstr->end() ; ++i)
  {
    (*i)->accept(this);
    render("");
  }
...
void PrintAbsyn::visitAss(Ass* p)
{
  ...
  if(p->listlatteident_) {_i_ = 0; p->listlatteident_->accept(this);}  render('=');
...
void PrintAbsyn::visitAssObj(AssObj* p)
{
  int oldi = _i_;
  if (oldi > 0) render(_L_PAREN);
...
void PrintAbsyn::visitInitObj(InitObj* p)
{
  int oldi = _i_;
  if (oldi > 0) render(_L_PAREN);
...
void PrintAbsyn::visitLatteIdent(LatteIdent*p) {} //abstract class

void PrintAbsyn::visitSingleIdent(SingleIdent* p)
{
  int oldi = _i_;
  if (oldi > 0) render(_L_PAREN);
...
void PrintAbsyn::visitArrayIdent(ArrayIdent* p)
{
  int oldi = _i_;
  if (oldi > 0) render(_L_PAREN);
...
void PrintAbsyn::visitSelfIdent(SelfIdent* p)
{
  int oldi = _i_;
  if (oldi > 0) render(_L_PAREN);
...
void PrintAbsyn::visitListLatteIdent(ListLatteIdent *listlatteident)
{
  for (ListLatteIdent::const_iterator i = listlatteident->begin() ; i != listlatteident->end() ; ++i)
  {
    (*i)->accept(this);
    if (i != listlatteident->end() - 1) render('.');
  }
}
...
void PrintAbsyn::visitEVar(EVar* p)
{
  ...
  if(p->listlatteident_) {_i_ = 0; p->listlatteident_->accept(this);}
...
void PrintAbsyn::visitEInstanceApp(EInstanceApp* p)
{
  int oldi = _i_;
  if (oldi > 6) render(_L_PAREN);
...
void ShowAbsyn::visitClassDefNoInher(ClassDefNoInher* p)
{
  bufAppend('(');
  bufAppend("ClassDefNoInher");
  bufAppend(' ');
  visitIdent(p->ident_);
  bufAppend(' ');
  bufAppend('[');
  if (p->listclassinstr_)  p->listclassinstr_->accept(this);
  bufAppend(']');
  bufAppend(' ');
  bufAppend(')');
}
void ShowAbsyn::visitClassDefInher(ClassDefInher* p)
{
  bufAppend('(');
  bufAppend("ClassDefInher");
  bufAppend(' ');
  visitIdent(p->ident_1);
  bufAppend(' ');
  visitIdent(p->ident_2);
...
void ShowAbsyn::visitClassInstr(ClassInstr* p) {} //abstract class

void ShowAbsyn::visitMethodDef(MethodDef* p)
{
  bufAppend('(');
  bufAppend("MethodDef");
  bufAppend(' ');
...
void ShowAbsyn::visitFieldDef(FieldDef* p)
{
  bufAppend('(');
  bufAppend("FieldDef");
  bufAppend(' ');
...
void ShowAbsyn::visitListClassInstr(ListClassInstr *listclassinstr)
{
  for (ListClassInstr::const_iterator i = listclassinstr->begin() ; i != listclassinstr->end() ; ++i)
  {
    (*i)->accept(this);
    if (i != listclassinstr->end() - 1) bufAppend(", ");
  }
}
...
void ShowAbsyn::visitAss(Ass* p)
{
  ...
  bufAppend(' ');
  bufAppend('[');
  if (p->listlatteident_)  p->listlatteident_->accept(this);
  bufAppend(']');
  bufAppend(' ');
  bufAppend('[');
...
void ShowAbsyn::visitAssObj(AssObj* p)
{
  bufAppend('(');
  bufAppend("AssObj");
  bufAppend(' ');
...
void ShowAbsyn::visitInitObj(InitObj* p)
{
  bufAppend('(');
  bufAppend("InitObj");
  bufAppend(' ');
...
void ShowAbsyn::visitLatteIdent(LatteIdent* p) {} //abstract class

void ShowAbsyn::visitSingleIdent(SingleIdent* p)
{
  bufAppend('(');
  bufAppend("SingleIdent");
  bufAppend(' ');
  visitIdent(p->ident_);
  bufAppend(')');
}
void ShowAbsyn::visitArrayIdent(ArrayIdent* p)
{
  bufAppend('(');
  bufAppend("ArrayIdent");
  bufAppend(' ');
  visitIdent(p->ident_);
  bufAppend(' ');
  bufAppend('[');
...
void ShowAbsyn::visitSelfIdent(SelfIdent* p)
{
  bufAppend("SelfIdent");
}
void ShowAbsyn::visitListLatteIdent(ListLatteIdent *listlatteident)
{
  for (ListLatteIdent::const_iterator i = listlatteident->begin() ; i != listlatteident->end() ; ++i)
  {
    (*i)->accept(this);
    if (i != listlatteident->end() - 1) bufAppend(", ");
  }
}
...
void ShowAbsyn::visitEInstanceApp(EInstanceApp* p)
{
  bufAppend('(');
  bufAppend("EInstanceApp");
  bufAppend(' ');
  bufAppend('[');
  if (p->listlatteident_)  p->listlatteident_->accept(this);
  bufAppend(']');
